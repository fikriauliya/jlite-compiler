...
ocamlc -c jlite_simple_ir3converter.ml
ocamlc -c jlite_main.ml
ocamlc -o as2 jlite_structs.cmo jlite_simple_annotatedtyping.cmo jlite_simple_ir3converter.cmo jlite_lexer.cmo jlite_parser.cmo ir3_structs.cmo jlite_main.cmo